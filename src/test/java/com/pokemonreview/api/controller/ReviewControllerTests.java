...
public class ReviewControllerTests {
    ...
    @Test
    public void GivenPositiveValidValuesAsParams_WhenGetSumIsCalled_ThenItShouldReturnSumValue(){
        ...
        //when
        int actualResultSum = firstValue + secondValue;

        //then
        Assertions.assertThat(expectedSumResult).isEqualTo(actualResultSum);

    }


    @Test
    public void SumController_SumValues_returnPositiveValue(){
